...
local _T2 = {
	{d = 10469493270, r = 17325510002, s = 1, n = 17325528680, v = 1},
	{d = 10469630950, r = 17325513870, s = 1, n = 17325528583, v = 0.8},
	{d = 10469639222, r = 17325522388, s = 1, n = 17325528509, v = 0.7},
	{d = 10469643643, r = 17325537719, s = 1, n = 17325528401, v = 1},
...
local function _F3(i, v)
	if not _C2 then return end
	local s = Instance.new("Sound")
	s:SetAttribute("KJScript", true)
	s.SoundId = "rbxassetid://" .. i
	s.Volume = v or 1
	s.Parent = _C2
	s:Play()
